...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--epochs', type=int, required=False, default=300, help='how many epochs do we train this for')
    ...
    arg_parser.add_argument('--num_pretrain_epochs', type=int, default=300, help='number of epochs for pre-training of the encoder using simclr')
    arg_parser.add_argument('--diffusion', action='store_true', help='uses diffusion denoising for clean labels during training.')
    arg_parser.add_argument('--num_diffusion_epochs', type=int, default=300)
    arg_parser.add_argument('--coteaching', action='store_true')
